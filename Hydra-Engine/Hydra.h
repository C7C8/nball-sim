...
#include "game/ai/fsm/FiniteStateMachine.h"
#include "game/ai/fsm/FSMState.h"
#include "game/ai/fsm/FSMTransition.h"
...
#include "math/mathdefs.h" //TODO: Remove mathdefs.h if possible
...
namespace Hydra
{
	...
	public:
		...
		//Getters and setters
		void setWSize(int newXSize, int newYSize);				        //!< Sets the window size to the designated size
